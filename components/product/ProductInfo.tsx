...
import { formatPrice, calculateSavings, CONDITION_LABELS } from "@/lib/utils";
    ...
    <div className="space-y-6">
          ...
          <table className="w-full text-[14px]">
            <tbody>
              {Object.entries(product.specs).map(([key, value], i) => (
                ...
                >
                  <td className="px-4 py-3 text-text-muted font-medium w-1/3">
                    {key}
                  </td>
      ...
      {product.description && (
        <div className="space-y-2">
          <h2 className="font-headline font-semibold text-[16px] text-text-primary">
            Description
          </h2>
